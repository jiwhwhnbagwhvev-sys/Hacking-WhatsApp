...
# Deskripsi: Install dependencies, compile main.c, dan jalankan menu utama
...
install:
	...
	@echo "[*] Menginstall NodeJS packages..."
	...
	@clear
	@printf "\n\033[37m[\033[32m✓\033[37m] Package & module berhasil diinstall\n"
	@printf "\033[37m[\033[32m✓\033[37m] Jalankan script dengan ketik \033[1;30m'./main'\033[0m atau \033[1;30m'make run'\033[0m\n\n"
