...
<h1 style="color:#58a6ff;">Welcome</h1>

<hr style="width:80%; border:1px solid #30363d;">

<video width="900" controls style="border-radius:12px; box-shadow:0 0 20px rgba(0,0,0,0.6);">
